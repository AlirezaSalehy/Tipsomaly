model_version='L/16' # 'l14h' # l14h or l14
backbone_name='siglip2' # 'l14h' # l14h or l14
...
python test.py --dataset mvtec --devices $device --model_version $model_version --backbone_name $backbone_name --fixed_prompt_type object_agnostic --image_size 512
